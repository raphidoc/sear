...
To read the binaary HOCR file we will pass by the kaitai struct parser trough python (or cpp as it may improve speed, have to test).
...
Station1PaP <- interval(ymd_hms("2022-07-05 12:23:13"), ymd_hms("2022-07-05 12:23:15"))
...
FiltRawHOCR <- filter_hocr(RawHOCR, HOCRTimeIndex, TimeInt = Station1PaP)
```
