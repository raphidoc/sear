...
The HOCR data is quite large and mainly compose of bad data, acquired in transit, that we don´t want to loose time to process. Therefore, only the selected point designing a transect or a station need to enter the processing chain. For that we use filters on the `RawHOCR` list of HOCR packets.
