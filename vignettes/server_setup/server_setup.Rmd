...
sudo su - -c "R -e \"install.packages(c('shinyWidgets', 'spsComps', 'suncalc', 'tidyr', 'uuid', 'waiter', 'widgetframe', 'shinyjs', 'sodium', 'listviewer', 'sfheaders', 'htmlwidgets', 'gsw', 'pracma'))\""
